...
import type { TransactionRequest, CoinQuantityLike, Resource, ExcludeResourcesOption, Provider, ScriptTransactionRequestLike, TransactionCost, EstimateTransactionParams, CursorPaginationArgs, TransactionRequestLike, ProviderSendTxParams, CallResult, GetCoinsResponse, GetMessagesResponse, GetBalancesResponse, Coin, TransactionCostParams, TransactionResponse } from './providers';
...
export declare class Account extends AbstractAccount {
     ...
     */
    createTransfer(destination: string | AbstractAddress, amount: BigNumberish, assetId?: BytesLike, txParams?: TxParamsType): Promise<ScriptTransactionRequest>;
    /**
