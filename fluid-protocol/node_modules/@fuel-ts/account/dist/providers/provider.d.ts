...
type SdkOperations = Omit<Operations, 'submitAndAwait' | 'statusChange' | 'submitAndAwaitStatus'> & {
    /**
     ...
     */
    submitAndAwait: (...args: Parameters<Operations['submitAndAwait']>) => Promise<ReturnType<Operations['submitAndAwait']>>;
...
export default class Provider {
     ...
     */
    getCoins(owner: string | AbstractAddress, assetId?: BytesLike, paginationArgs?: CursorPaginationArgs): Promise<GetCoinsResponse>;
    /**
     ...
     */
    getBalances(owner: string | AbstractAddress): Promise<GetBalancesResponse>;
    /**
     ...
     */
    getMessages(address: string | AbstractAddress, paginationArgs?: CursorPaginationArgs): Promise<GetMessagesResponse>;
    /**
