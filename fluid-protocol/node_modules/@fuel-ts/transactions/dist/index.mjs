...
var ReceiptCoder = class extends Coder5 {
  ...
  encode(value) {
    ...
    switch (value.type) {
      ...
      default: {
        throw new FuelError5(ErrorCode5.INVALID_RECEIPT_TYPE, `Invalid receipt type: ${type}`);
      }
    }
    return concat5(parts);
  }
...
var TransactionBlobCoder = class extends Coder8 {
  constructor() {
    super("TransactionBlob", "struct TransactionBlob", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new B256Coder6().encode(value.blobId));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.witnessIndex));
    parts.push(new NumberCoder8("u32", { padToWordSize: true }).encode(value.policyTypes));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.inputsCount));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.outputsCount));
    ...
    switch (value.type) {
      ...
      default: {
        throw new FuelError7(
          ErrorCode7.UNSUPPORTED_TRANSACTION_TYPE,
          `Unsupported transaction type: ${type}`
        );
      }
    }
...
var UtxoIdCoder = class extends StructCoder3 {
  constructor() {
    super("UtxoId", {
      ...
      outputIndex: new NumberCoder9("u16", { padToWordSize: true })
    });
  }
};
export {
