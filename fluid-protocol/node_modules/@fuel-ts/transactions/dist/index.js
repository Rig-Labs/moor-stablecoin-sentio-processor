...
var ReceiptCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    ...
    switch (value.type) {
      ...
      default: {
        throw new import_errors5.FuelError(import_errors5.ErrorCode.INVALID_RECEIPT_TYPE, `Invalid receipt type: ${type}`);
      }
    }
    return (0, import_utils5.concat)(parts);
  }
    ...
    switch (value.type) {
      ...
      default: {
        throw new import_errors7.FuelError(
          import_errors7.ErrorCode.UNSUPPORTED_TRANSACTION_TYPE,
          `Unsupported transaction type: ${type}`
        );
      }
    }
