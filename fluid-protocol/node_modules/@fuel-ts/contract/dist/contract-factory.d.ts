...
export default class ContractFactory {
     ...
     */
    deploy<TContract extends Contract = Contract>(deployOptions?: DeployContractOptions): Promise<DeployContractResult<TContract>>;
    /**
     ...
     * @returns A promise that resolves to the deployed contract instance.
     */
    deployAsCreateTx<TContract extends Contract = Contract>(deployOptions?: DeployContractOptions): Promise<DeployContractResult<TContract>>;
    /**
     ...
     * @returns A promise that resolves to the deployed contract instance.
     */
    deployAsBlobTx<TContract extends Contract = Contract>(deployOptions?: DeployContractOptions): Promise<DeployContractResult<TContract>>;
    deployAsBlobTxForScript(): Promise<{
        waitForResult: () => Promise<{
