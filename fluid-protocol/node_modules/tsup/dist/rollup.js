...
var _chunkLXDDJK3Ljs = require('./chunk-LXDDJK3L.js');
...
var require_hasown = _chunkOSC67C6Mjs.__commonJS.call(void 0, {
...
var require_picocolors = _chunkOSC67C6Mjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/picocolors@1.1.0/node_modules/picocolors/picocolors.js"(exports, module) {
    var argv = process.argv || [];
    var env = process.env;
    var isColorSupported = !("NO_COLOR" in env || argv.includes("--no-color")) && ("FORCE_COLOR" in env || argv.includes("--color") || process.platform === "win32" || _chunkOSC67C6Mjs.__require != null && _chunkOSC67C6Mjs.__require.call(void 0, "tty").isatty(1) && env.TERM !== "dumb" || "CI" in env);
...
// node_modules/.pnpm/rollup-plugin-dts@5.3.0_rollup@3.29.4_typescript@5.0.2/node_modules/rollup-plugin-dts/dist/rollup-plugin-dts.cjs
var require_rollup_plugin_dts = _chunkOSC67C6Mjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/rollup-plugin-dts@5.3.0_rollup@3.29.4_typescript@5.0.2/node_modules/rollup-plugin-dts/dist/rollup-plugin-dts.cjs"(exports) {
    "use strict";
...
// src/rollup.ts
var import_rollup_plugin_hashbang = _chunkOSC67C6Mjs.__toESM.call(void 0, _chunkLXDDJK3Ljs.require_dist.call(void 0, ));
var _worker_threads = require('worker_threads');
var _typescript = require('typescript'); var _typescript2 = _interopRequireDefault(_typescript);

// node_modules/.pnpm/@rollup+pluginutils@5.1.0_rollup@3.29.4/node_modules/@rollup/pluginutils/dist/es/index.js
...
var dataToEsm = function dataToEsm2(data, options = {}) {
  ...
  for (const key of Object.keys(data)) {
    const underbarPrefixLength = (_b = (_a2 = key.match(/^(_+)/)) === null || _a2 === void 0 ? void 0 : _a2[0].length) !== null && _b !== void 0 ? _b : 0;
...
// node_modules/.pnpm/@rollup+plugin-json@5.0.1_rollup@3.29.4/node_modules/@rollup/plugin-json/dist/es/index.js
...
var logger = _chunkLXDDJK3Ljs.createLogger.call(void 0, );
...
var getRollupConfig = async (options) => {
  var _a2;
  _chunkLXDDJK3Ljs.setSilent.call(void 0, options.silent);
  ...
  const deps = await _chunkLXDDJK3Ljs.getProductionDeps.call(void 0, process.cwd());
...
async function runRollup(options) {
  ...
  try {
    ...
    _chunkLXDDJK3Ljs.reportSize.call(void 0, 
      logger,
      "dts",
