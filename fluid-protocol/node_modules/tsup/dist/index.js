...
var _chunkFTLH6NM5js = require('./chunk-FTLH6NM5.js');
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkLXDDJK3Ljs.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  const pkg = await _chunkLXDDJK3Ljs.loadPkg.call(void 0, process.cwd());
  ...
  if (result && result.warnings && !_chunkLXDDJK3Ljs.getSilent.call(void 0, )) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkLXDDJK3Ljs.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger2 = _chunkLXDDJK3Ljs.createLogger.call(void 0, item == null ? void 0 : item.name);
        const options = await normalizeOptions(logger2, item, _options);
        logger2.info("CLI", `tsup v${_chunkFTLH6NM5js.version}`);
        if (config.path) {
        ...
        const mainTasks = async () => {
          ...
          if (!((_a = options.dts) == null ? void 0 : _a.only)) {
            ...
            let depsHash = await _chunkLXDDJK3Ljs.getAllDepsHash.call(void 0, process.cwd());
              ...
              watcher.on("all", async (type, file) => {
                ...
                if (options.watch === true) {
                  if (file === "package.json" && !buildDependencies.has(file)) {
                    const currentHash = await _chunkLXDDJK3Ljs.getAllDepsHash.call(void 0, process.cwd());
