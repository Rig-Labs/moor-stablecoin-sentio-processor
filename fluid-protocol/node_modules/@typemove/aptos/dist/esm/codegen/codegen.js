...
import { AbstractCodegen, camel, normalizeToJSName } from '@typemove/move';
import { Aptos, AptosConfig } from '@aptos-labs/ts-sdk';
export async function codegen(abisDir, outDir = join('src', 'types', 'aptos'), endpoint, genExample = false, builtin = false) {
