import { AptosQueryDefinition } from '@sentio/protos/chainquery';
...
export function getChainQueryClient(address) {
    if (!address) {
...
export function getAptosClient(network = AptosNetwork.MAIN_NET) {
