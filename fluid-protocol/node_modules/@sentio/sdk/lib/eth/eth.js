import { formatBlock, formatLog, formatTransactionResponse, allowNull, arrayOf, formatHash, formatReceiptLog, object, formatData } from 'ethers/providers';
...
export function formatEthData(data) {
    ...
    const trace = data.trace ? data.trace : undefined;
...
export function formatRichBlock(block) {
