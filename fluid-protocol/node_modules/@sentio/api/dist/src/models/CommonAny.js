 ...
 */
import { CommonStringListFromJSON, CommonStringListToJSON, } from './CommonStringList.js';
/**
 * Check if a given object implements the CommonAny interface.
 */
export function instanceOfCommonAny(value) {
    return true;
}
export function CommonAnyFromJSON(json) {
    return CommonAnyFromJSONTyped(json, false);
}
export function CommonAnyFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function CommonAnyToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=CommonAny.js.map