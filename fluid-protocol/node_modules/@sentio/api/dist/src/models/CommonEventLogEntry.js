 ...
 */
export function instanceOfCommonEventLogEntry(value) {
    return true;
}
export function CommonEventLogEntryFromJSON(json) {
    return CommonEventLogEntryFromJSONTyped(json, false);
}
export function CommonEventLogEntryFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function CommonEventLogEntryToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=CommonEventLogEntry.js.map